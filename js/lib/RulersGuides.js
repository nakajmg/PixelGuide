...
var RulersGuides = function (evt, dragdrop) {
    ...
    rgmediator
      .on("toggleGuides", function(e, data) { toggleGuides(); })
      .on("toggleRulers", function(e, data) { toggleRulers(); })
      .on("toggleRulersLock", function(e, data) { toggleRulersLock(); })
      .on("saveGrid", function(e, data) { saveGrid(); })
      .on("removeGrid", function(e, data) { removeGrid(); })
      .on("deleteGuides", function(e, data) { deleteGuides(); })
      .on("openGridDialog", function(e, data) { openGridDialog.open(); })
      .on("showDetailedInfo", function(e, data) { detailsStatus = 1 - detailsStatus; showDetailedInfo(); })
      .on("snapDom", function(e, data) {
        snapDom = 1 - snapDom;
